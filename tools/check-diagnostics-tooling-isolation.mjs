...
check(index.includes('app.js?v=attendance-canonical-ownership-20260616') || index.includes('app.js?v=inventory-pagination-complete-debt-20260616'), 'app.js cache-bust advances beyond Phase 4K-6T');
check(index.includes('main.js?v=attendance-canonical-ownership-20260616') || index.includes('main.js?v=inventory-pagination-complete-debt-20260616'), 'main.js cache-bust advances beyond Phase 4K-6T');
