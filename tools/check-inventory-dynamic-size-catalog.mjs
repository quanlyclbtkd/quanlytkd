...
check('Changed nested modules are cache-busted', (mainSrc.includes("multiItemInventorySafety.js?v=superadmin-access-admin-provisioning-recovery-20260704-v5k") || mainSrc.includes("multiItemInventorySafety.js?v=inventory-dynamic-size-catalog-20260616-v2b") || mainSrc.includes("multiItemInventorySafety.js?v=inventory-ledger-reconciliation-20260616-v2c")) && (inventoryModuleSrc.includes("inventory.service.js?v=superadmin-access-admin-provisioning-recovery-20260704-v5k") || inventoryModuleSrc.includes("inventory.service.js?v=inventory-dynamic-size-catalog-20260616-v2b") || inventoryModuleSrc.includes("inventory.service.js?v=inventory-ledger-reconciliation-20260616-v2c")));
