...
check('Changed nested modules are cache-busted', (mainSrc.includes("multiItemInventorySafety.js?v=role-runtime-audit-profiler-20260704-v5o") || mainSrc.includes("multiItemInventorySafety.js?v=debt-zalo-feature-off-20260704-v5n") || mainSrc.includes("multiItemInventorySafety.js?v=inventory-dynamic-size-catalog-20260616-v2b") || mainSrc.includes("multiItemInventorySafety.js?v=inventory-ledger-reconciliation-20260616-v2c")) && (inventoryModuleSrc.includes("inventory.service.js?v=role-runtime-audit-profiler-20260704-v5o") || inventoryModuleSrc.includes("inventory.service.js?v=debt-zalo-feature-off-20260704-v5n") || inventoryModuleSrc.includes("inventory.service.js?v=inventory-dynamic-size-catalog-20260616-v2b") || inventoryModuleSrc.includes("inventory.service.js?v=inventory-ledger-reconciliation-20260616-v2c")));
