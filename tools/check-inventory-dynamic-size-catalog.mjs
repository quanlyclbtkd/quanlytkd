...
check('Changed nested modules are cache-busted', (mainSrc.includes("multiItemInventorySafety.js?v=login-history-large-list-guard-20260703-v5h") || mainSrc.includes("multiItemInventorySafety.js?v=inventory-dynamic-size-catalog-20260616-v2b") || mainSrc.includes("multiItemInventorySafety.js?v=inventory-ledger-reconciliation-20260616-v2c")) && (inventoryModuleSrc.includes("inventory.service.js?v=login-history-large-list-guard-20260703-v5h") || inventoryModuleSrc.includes("inventory.service.js?v=inventory-dynamic-size-catalog-20260616-v2b") || inventoryModuleSrc.includes("inventory.service.js?v=inventory-ledger-reconciliation-20260616-v2c")));
