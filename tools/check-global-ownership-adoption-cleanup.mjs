...
check(main.includes("window.APP_BUILD_VERSION = '4K-6W-secure-account-provisioning-rules-lockdown-20260616'"), 'active APP_BUILD_VERSION advances to Phase 4K-6V');
check(index.includes('main.js?v=secure-account-provisioning-20260616'), 'index cache bust advances to Phase 4K-6V');
