...
assert(/lazyAssetsBootstrap\.js\?v=mobile-startup-lazy-assets-20260608/.test(index), 'index.html must load lazyAssetsBootstrap before app.js');
...
assert(/APP_BUILD_VERSION\s*=\s*'4K-6O-mobile-startup-performance-lazy-assets-20260608'/.test(main), 'APP_BUILD_VERSION must be 4K-6O');
...
assert(/main\.js\?v=mobile-startup-lazy-assets-20260608/.test(index), 'index.html main.js cache bust must be 4K-6O');
