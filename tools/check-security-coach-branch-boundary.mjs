...
check('All 6V4B runtime entry assets share one cache-bust marker',
  ((index.match(/coach-branch-runtime-repair-20260627-v4b1/g) || []).length >= 5) || ((index.match(/role-runtime-audit-profiler-20260704-v5o/g) || []).length >= 5) || ((index.match(/debt-zalo-feature-off-20260704-v5n/g) || []).length >= 5) || ((index.match(/quit-authoritative-data-boundary-20260704-v5p/g) || []).length >= 5));
