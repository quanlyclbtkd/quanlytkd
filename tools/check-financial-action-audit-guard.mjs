...
must(tuitionBoundary.includes("_guard('tuition.quickPay'"), 'quickPay có Write Intent Guard tại TuitionCommandBoundary');
must(tuitionBoundary.includes("_audit('tuition.quickPay', 'before'") && tuitionBoundary.includes("_audit('tuition.quickPay', 'after'") && tuitionBoundary.includes("_audit('tuition.quickPay', 'error'"), 'quickPay có audit before/after/error tại owner mới');
...
must(tuitionBoundary.includes("_guard('transaction.delete'") && finance.includes("guardFinancialWriteIntent('transaction.delete'"), 'deleteTx có guard cho cả tuition và non-tuition path');
must(tuitionBoundary.includes("_audit('transaction.delete', 'before'") && tuitionBoundary.includes("_audit('transaction.delete', 'after'") && tuitionBoundary.includes("_audit('transaction.delete', 'error'") && finance.includes("recordFinancialActionAudit?.('transaction.delete', 'before'") && finance.includes("recordFinancialActionAudit?.('transaction.delete', 'after'") && finance.includes("recordFinancialActionAudit?.('transaction.delete', 'error'"), 'deleteTx có audit before/after/error ở đúng owner');
