...
const appEntrypointBuilds = ['profile-canonical-store-mobile-small-ui-20260628-v4d1b', 'profile-canonical-store-20260628-v4d1', 'tuition-debt-source-of-truth-20260628-v4c'];
check('Production entrypoints keep V4B1 branch repair and load current runtime cache marker',
  ...
  (index.includes('./js/main.js?v=profile-canonical-store-mobile-small-ui-20260628-v4d1b') || index.includes('./js/main.js?v=profile-canonical-store-20260628-v4d1')) &&
  (main.includes("profiles.listeners.js?v=profile-canonical-store-mobile-small-ui-20260628-v4d1b") || main.includes("profiles.listeners.js?v=profile-canonical-store-20260628-v4d1")) &&
