...
check('Production entrypoints keep V4B1 branch repair and load current quit-tab cache marker',
  ...
  index.includes('app.js?v=quit-tab-mobile-authoritative-render-20260627-v4b5') &&
  index.includes('./js/main.js?v=quit-tab-mobile-authoritative-render-20260627-v4b5') &&
  main.includes("profiles.listeners.js?v=quit-tab-mobile-authoritative-render-20260627-v4b5") &&
