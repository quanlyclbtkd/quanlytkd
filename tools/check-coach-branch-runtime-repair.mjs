...
const appEntrypointBuilds = ['canonical-profile-status-branch-boundary-20260701-v5', 'superadmin-access-recovery-20260630-v4d12', 'profile-canonical-store-runtime-recovery-20260628-v4d1a', 'profile-canonical-store-20260628-v4d1', 'tuition-debt-source-of-truth-20260628-v4c'];
check('Production entrypoints keep V4B1 branch repair and load current runtime cache marker',
  ((index.match(/coach-branch-runtime-repair-20260627-v4b1/g) || []).length >= 5 || (index.includes('canonical-profile-status-branch-boundary-20260701-v5') || index.includes('superadmin-access-recovery-20260630-v4d12'))) &&
  appEntrypointBuilds.some(build => index.includes(`app.js?v=${build}`)) &&
  (index.includes('./js/main.js?v=canonical-profile-status-branch-boundary-20260701-v5') || index.includes('./js/main.js?v=superadmin-access-recovery-20260630-v4d12') || index.includes('./js/main.js?v=profile-canonical-store-runtime-recovery-20260628-v4d1a') || index.includes('./js/main.js?v=profile-canonical-store-20260628-v4d1')) &&
  (main.includes("profiles.listeners.js?v=canonical-profile-status-branch-boundary-20260701-v5") || main.includes("profiles.listeners.js?v=superadmin-access-recovery-20260630-v4d12") || main.includes("profiles.listeners.js?v=profile-canonical-store-runtime-recovery-20260628-v4d1a") || main.includes("profiles.listeners.js?v=profile-canonical-store-20260628-v4d1")) &&
  (main.includes("attendance.js?v=canonical-profile-status-branch-boundary-20260701-v5") || main.includes("attendance.js?v=superadmin-access-recovery-20260630-v4d12") || main.includes("attendance.js?v=coach-branch-runtime-repair-20260627-v4b1")));
