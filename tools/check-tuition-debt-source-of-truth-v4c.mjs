...
check('index loads tuitionDebtCanonical before app.js', (() => {
  ...
  return html.indexOf('js/core/tuitionDebtCanonical.js?v=profile-canonical-store-regression-hotfix-20260628-v4d1a') > -1 &&
    html.indexOf('js/core/tuitionDebtCanonical.js?v=profile-canonical-store-regression-hotfix-20260628-v4d1a') < html.indexOf('app.js?v=profile-canonical-store-regression-hotfix-20260628-v4d1a');
})());
check('app.js cache-bust updated to V4C', includes('index.html', 'app.js?v=profile-canonical-store-regression-hotfix-20260628-v4d1a'));
