...
check('index loads tuitionDebtCanonical before app.js', (() => {
  ...
  return html.indexOf('js/core/tuitionDebtCanonical.js?v=profile-canonical-store-mobile-small-ui-20260628-v4d1b') > -1 &&
    html.indexOf('js/core/tuitionDebtCanonical.js?v=profile-canonical-store-mobile-small-ui-20260628-v4d1b') < html.indexOf('app.js?v=profile-canonical-store-mobile-small-ui-20260628-v4d1b');
})());
check('app.js cache-bust updated to current V4D1A build', includes('index.html', 'app.js?v=profile-canonical-store-mobile-small-ui-20260628-v4d1b'));
