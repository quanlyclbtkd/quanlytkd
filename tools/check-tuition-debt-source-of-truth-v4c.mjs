...
check('index loads tuitionDebtCanonical before app.js', (() => {
  ...
  const appIdx = Math.max(html.indexOf('app.js?v=coach-attendance-branch-hydration-20260630-v4d6'), html.indexOf('app.js?v=quit-authoritative-full-sync-20260629-v4d4'));
  return tuitionIdx > -1 && appIdx > -1 && tuitionIdx < appIdx;
})());
check('app.js cache-bust updated to current quit authoritative full-sync build', includes('index.html', 'app.js?v=coach-attendance-branch-hydration-20260630-v4d6') || includes('index.html', 'app.js?v=quit-authoritative-full-sync-20260629-v4d4'));
