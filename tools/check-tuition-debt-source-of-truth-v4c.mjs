...
check('index loads tuitionDebtCanonical before app.js', (() => {
  ...
  return html.indexOf('js/core/tuitionDebtCanonical.js?v=profile-canonical-store-20260628-v4d1') > -1 &&
    html.indexOf('js/core/tuitionDebtCanonical.js?v=profile-canonical-store-20260628-v4d1') < html.indexOf('app.js?v=profile-canonical-store-20260628-v4d1');
})());
check('app.js cache-bust updated to V4C', includes('index.html', 'app.js?v=profile-canonical-store-20260628-v4d1'));
