...
check('index loads tuitionDebtCanonical before app.js', (() => {
  ...
  return html.indexOf('js/core/tuitionDebtCanonical.js?v=coach-profiles-bootstrap-datasource-recovery-20260702-v5c') > -1 &&
    html.indexOf('js/core/tuitionDebtCanonical.js?v=coach-profiles-bootstrap-datasource-recovery-20260702-v5c') < html.indexOf('app.js?v=coach-profiles-bootstrap-datasource-recovery-20260702-v5c');
})());
check('app.js cache-bust updated to current V4D1A build', includes('index.html', 'app.js?v=coach-profiles-bootstrap-datasource-recovery-20260702-v5c'));
