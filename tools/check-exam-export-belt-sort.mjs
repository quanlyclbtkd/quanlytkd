...
check(
    ...
    indexHtml.includes('4K-6H') || indexHtml.includes('legacy-render-entrypoint-reduction') || indexHtml.includes('4K-6I') || indexHtml.includes('inline-handler-bridge') || indexHtml.includes('4K-6I-B') || indexHtml.includes('superadmin-quota') || indexHtml.includes('runtime-fallback-fix'),
