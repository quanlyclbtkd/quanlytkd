...
const appBuilds = [r1Build, excelFixBuild, appBuild, previousAppBuild, build, 'profile-canonical-store-runtime-recovery-20260628-v4d1a', 'profile-canonical-store-20260628-v4d1', 'tuition-debt-source-of-truth-20260628-v4c'];

check('index cache-busts app.js/main.js to current render-safe build',
  (index.includes(`app.js?v=${appBuild}`) || appBuilds.some(b => index.includes(`app.js?v=${b}`))) && (index.includes(`main.js?v=${r1Build}`) || index.includes(`main.js?v=${dashboardBuild}`) || index.includes(`main.js?v=${searchBuild}`) || index.includes(`main.js?v=${appBuild}`) || index.includes(`main.js?v=${build}`)));
