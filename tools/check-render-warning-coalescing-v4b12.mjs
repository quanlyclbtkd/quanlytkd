...
check('index cache-busts app.js/main.js to current render-safe build',
  (index.includes(`app.js?v=${appBuild}`) || appBuilds.some(b => index.includes(`app.js?v=${b}`))) && (index.includes(`main.js?v=${dashboardBuild}`) || index.includes(`main.js?v=${searchBuild}`) || index.includes(`main.js?v=${appBuild}`) || index.includes(`main.js?v=${build}`)));
