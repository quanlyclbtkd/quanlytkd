...
check('main.js version là tuition-layout-loadmore-exam-export-fix',
    html.includes('tuition-layout-loadmore-exam-export-fix') || html.includes('real-layout-real-loadmore-fix') || html.includes('debt-active-loadmore-scroll-fix') || html.includes('debt-loadmore-overdue-filter-fix') || html.includes('active-loadmore-newest-first-fix'),
