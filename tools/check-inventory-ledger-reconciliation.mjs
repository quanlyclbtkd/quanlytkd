...
check('Changed inventory/student/finance modules are cache-busted', main.includes("modules/students.js?v=tx-delete-reconcile-smart-search-20260703-v5c") && main.includes("modules/finance.js?v=tx-delete-reconcile-smart-search-20260703-v5c") && main.includes("modules/inventory.js?v=tx-delete-reconcile-smart-search-20260703-v5c"));
check('Changed service imports are cache-busted', invModule.includes("inventory.service.js?v=tx-delete-reconcile-smart-search-20260703-v5c") && financeService.includes("inventory.service.js?v=tx-delete-reconcile-smart-search-20260703-v5c"));
