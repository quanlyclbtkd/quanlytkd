...
check('Changed inventory/student/finance modules are cache-busted', main.includes("modules/students.js?v=given-name-search-20260703-v5d") && main.includes("modules/finance.js?v=given-name-search-20260703-v5d") && main.includes("modules/inventory.js?v=given-name-search-20260703-v5d"));
check('Changed service imports are cache-busted', invModule.includes("inventory.service.js?v=given-name-search-20260703-v5d") && financeService.includes("inventory.service.js?v=given-name-search-20260703-v5d"));
