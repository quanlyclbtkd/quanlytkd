...
check('Changed inventory/student/finance modules are cache-busted', main.includes("modules/students.js?v=inventory-ledger-reconciliation-20260616-v2c") && main.includes("modules/finance.js?v=inventory-ledger-reconciliation-20260616-v2c") && main.includes("modules/inventory.js?v=inventory-ledger-reconciliation-20260616-v2c"));
