...
check('Changed inventory/student/finance modules are cache-busted', main.includes("modules/students.js?v=login-history-large-list-guard-20260703-v5h") && main.includes("modules/finance.js?v=login-history-large-list-guard-20260703-v5h") && main.includes("modules/inventory.js?v=login-history-large-list-guard-20260703-v5h"));
check('Changed service imports are cache-busted', invModule.includes("inventory.service.js?v=login-history-large-list-guard-20260703-v5h") && financeService.includes("inventory.service.js?v=login-history-large-list-guard-20260703-v5h"));
