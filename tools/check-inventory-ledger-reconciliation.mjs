...
check('Changed inventory/student/finance modules are cache-busted', main.includes("modules/students.js?v=attendance-status-quit-sync-20260704-v5m") && main.includes("modules/finance.js?v=attendance-status-quit-sync-20260704-v5m") && main.includes("modules/inventory.js?v=attendance-status-quit-sync-20260704-v5m"));
check('Changed service imports are cache-busted', invModule.includes("inventory.service.js?v=attendance-status-quit-sync-20260704-v5m") && financeService.includes("inventory.service.js?v=attendance-status-quit-sync-20260704-v5m"));
