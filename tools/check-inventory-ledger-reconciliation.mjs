...
check('Changed inventory/student/finance modules are cache-busted', main.includes("modules/students.js?v=superadmin-access-admin-provisioning-recovery-20260704-v5k") && main.includes("modules/finance.js?v=superadmin-access-admin-provisioning-recovery-20260704-v5k") && main.includes("modules/inventory.js?v=superadmin-access-admin-provisioning-recovery-20260704-v5k"));
check('Changed service imports are cache-busted', invModule.includes("inventory.service.js?v=superadmin-access-admin-provisioning-recovery-20260704-v5k") && financeService.includes("inventory.service.js?v=superadmin-access-admin-provisioning-recovery-20260704-v5k"));
