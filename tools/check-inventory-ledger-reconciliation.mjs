...
check('Changed inventory/student/finance modules are cache-busted', main.includes("modules/students.js?v=audit-gate-superadmin-hardening-20260703-v5e") && main.includes("modules/finance.js?v=audit-gate-superadmin-hardening-20260703-v5e") && main.includes("modules/inventory.js?v=audit-gate-superadmin-hardening-20260703-v5e"));
check('Changed service imports are cache-busted', invModule.includes("inventory.service.js?v=audit-gate-superadmin-hardening-20260703-v5e") && financeService.includes("inventory.service.js?v=audit-gate-superadmin-hardening-20260703-v5e"));
