...
check('Changed inventory/student/finance modules are cache-busted', main.includes("modules/students.js?v=role-runtime-audit-profiler-20260704-v5o") && main.includes("modules/finance.js?v=role-runtime-audit-profiler-20260704-v5o") && main.includes("modules/inventory.js?v=role-runtime-audit-profiler-20260704-v5o"));
check('Changed service imports are cache-busted', invModule.includes("inventory.service.js?v=role-runtime-audit-profiler-20260704-v5o") && financeService.includes("inventory.service.js?v=role-runtime-audit-profiler-20260704-v5o"));
