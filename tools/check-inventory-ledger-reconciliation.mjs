...
check('Changed inventory/student/finance modules are cache-busted', (main.includes("modules/students.js?v=student-status-command-cutover-tx-delete-fix-20260722-v5u1") || main.includes("modules/students.js?v=quit-context-render-loop-guard-20260722-v5s") || main.includes("modules/students.js?v=profile-canonical-store-runtime-recovery-20260628-v4d1a")) && (main.includes("modules/finance.js?v=student-status-command-cutover-tx-delete-fix-20260722-v5u1") || main.includes("modules/finance.js?v=inventory-ledger-reconciliation-20260616-v2c")) && (main.includes("modules/inventory.js?v=payment-bundle-runtime-hotfix-20260616-v3a1") || main.includes("modules/inventory.js?v=inventory-ledger-reconciliation-20260616-v2c")));
