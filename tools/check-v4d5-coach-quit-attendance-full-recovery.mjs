...
check('APP_PATCH_VERSION marks V4D5', files.app.includes("APP_PATCH_VERSION = '4K-6V5C-coach-attendance-tap-stability-20260701'") && files.main.includes("APP_PATCH_VERSION = '4K-6V5C-coach-attendance-tap-stability-20260701'"));
...
check('public mirror is synced', files.publicProfiles.includes('coach-branch-legacy-one-shot-after-canonical') && files.publicRenderStudents.includes('both web and mobile must prefer') && files.publicFinance.includes(`finance.service.js?v=${BUILD}`));
