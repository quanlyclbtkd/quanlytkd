...
check('APP_PATCH_VERSION marks V4D5', ACCEPTED_PATCH_VERSIONS.some(v => files.app.includes(`APP_PATCH_VERSION = '${v}'`) && files.main.includes(`APP_PATCH_VERSION = '${v}'`)));
