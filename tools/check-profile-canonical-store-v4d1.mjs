...
const runtimeBuild = 'quit-mobile-authoritative-local-sync-20260628-v4d3';
...
check('main.js retains V4D1 lineage marker', main.includes(`APP_BUILD_VERSION = '${runtimeVersion}'`) || main.includes(`APP_PATCH_VERSION = '${runtimeVersion}'`) || main.includes("APP_PATCH_VERSION = '4K-6V4D2-mobile-small-ui-recovery-20260628'") || main.includes(`APP_BUILD_VERSION = '${version}'`) || main.includes(`APP_PATCH_VERSION = '${version}'`));
