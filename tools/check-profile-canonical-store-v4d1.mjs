...
check('index cache-busts app.js and main.js to V4D1', index.includes(`app.js?v=${build}`) && index.includes(`./js/main.js?v=${build}`));
check('main.js APP_PATCH_VERSION is V4D1', main.includes(`APP_PATCH_VERSION = '${version}'`));
