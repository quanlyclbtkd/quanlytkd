...
const superAdminAppBuild = 'superadmin-verified-auth-contract-20260811-v5u4';
...
const olderAppBuild = 'canonical-domain-command-boundary-write-freeze-20260722-v5t';
...
check('index loads profileCanonicalStore after tuitionDebtCanonical and before app.js',
  (() => {
    ...
    const appIdx = index.indexOf(`app.js?v=${superAdminAppBuild}`) >= 0 ? index.indexOf(`app.js?v=${superAdminAppBuild}`) : (index.indexOf(`app.js?v=${currentAppBuild}`) >= 0 ? index.indexOf(`app.js?v=${currentAppBuild}`) : (index.indexOf(`app.js?v=${tuitionAppBuild}`) >= 0 ? index.indexOf(`app.js?v=${tuitionAppBuild}`) : (index.indexOf(`app.js?v=${previousAppBuild}`) >= 0 ? index.indexOf(`app.js?v=${previousAppBuild}`) : (index.indexOf(`app.js?v=${olderAppBuild}`) >= 0 ? index.indexOf(`app.js?v=${olderAppBuild}`) : Math.max(...builds.map(b => index.indexOf(`app.js?v=${b}`)))))));
    return tuitionIdx > -1 && profileIdx > tuitionIdx && appIdx > profileIdx;
  })());
check('index cache-busts app.js and main.js to V4D1A-or-later', (index.includes(`app.js?v=${superAdminAppBuild}`) && index.includes(`./js/main.js?v=${superAdminAppBuild}`)) || (index.includes(`app.js?v=${currentAppBuild}`) && index.includes(`./js/main.js?v=${currentAppBuild}`)) || (index.includes(`app.js?v=${tuitionAppBuild}`) && index.includes(`./js/main.js?v=${tuitionAppBuild}`)) || (index.includes(`app.js?v=${previousAppBuild}`) && index.includes(`./js/main.js?v=${previousAppBuild}`)) || (index.includes(`app.js?v=${olderAppBuild}`) && index.includes(`./js/main.js?v=${olderAppBuild}`)) || builds.some(b => index.includes(`app.js?v=${b}`) && index.includes(`./js/main.js?v=${b}`)));
