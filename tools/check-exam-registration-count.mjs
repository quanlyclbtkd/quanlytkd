...
check(
    ...
    htmlSrc.includes('exam-count') || htmlSrc.includes('student-quit-separation') || htmlSrc.includes('exam-name-parser') || htmlSrc.includes('hotfix') || htmlSrc.includes('canonical-domain-command-boundary-write-freeze-20260722-v5t') || htmlSrc.includes('student-status-command-cutover-tx-delete-fix-20260722-v5u1') || htmlSrc.includes('tuition-command-cutover-20260730-v5u2'),
