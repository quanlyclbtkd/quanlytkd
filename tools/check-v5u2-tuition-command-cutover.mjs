...
const authBuild = 'superadmin-verified-auth-contract-20260811-v5u4';
const authPatch = '4K-6V5U4-superadmin-verified-auth-contract-20260811';
...
check('V5U-2 app/index/main markers active', (app.includes(patch) || app.includes(compatiblePatch) || app.includes(authPatch)) && (main.includes(patch) || main.includes(compatiblePatch) || main.includes(authPatch)) && (index.includes(`app.js?v=${build}`) || index.includes(`app.js?v=${compatibleBuild}`) || index.includes(`app.js?v=${authBuild}`)) && (index.includes(`./js/main.js?v=${authBuild}`) || index.includes(`./js/main.js?v=${searchBuild}`) || index.includes(`./js/main.js?v=${build}`) || index.includes(`./js/main.js?v=${compatibleBuild}`)));
check('V5U-2 public app/index/main markers active', (appPublic.includes(patch) || appPublic.includes(compatiblePatch) || appPublic.includes(authPatch)) && (mainPublic.includes(patch) || mainPublic.includes(compatiblePatch) || mainPublic.includes(authPatch)) && (indexPublic.includes(`app.js?v=${build}`) || indexPublic.includes(`app.js?v=${compatibleBuild}`) || indexPublic.includes(`app.js?v=${authBuild}`)) && (indexPublic.includes(`./js/main.js?v=${authBuild}`) || indexPublic.includes(`./js/main.js?v=${searchBuild}`) || indexPublic.includes(`./js/main.js?v=${build}`) || indexPublic.includes(`./js/main.js?v=${compatibleBuild}`)));
