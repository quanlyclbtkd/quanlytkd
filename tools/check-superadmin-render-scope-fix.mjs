...
check(main && main.includes('4K-6I-E-superadmin-render-scope-fix') || main.includes('4K-6I-G-server-superadmin-summary-cache') || main.includes('4K-6I-H-superadmin-safe-server-refresh') || main.includes('4K-6I-I-excel-import-vtf-upsert'), 'APP_BUILD_VERSION updated to 4K-6I-E', 'APP_BUILD_VERSION not updated to 4K-6I-E');
check(index && (index.includes('superadmin-render-scope-fix-20260607') || index.includes('auto-club-stats-cache-sync-20260607') || index.includes('server-superadmin-summary-cache-20260607') || index.includes('superadmin-safe-server-refresh-20260608') || index.includes('excel-import-vtf-upsert-20260608')), 'index.html cache bust updated to 4K-6I-E/F', 'index.html cache bust not updated to 4K-6I-E/F');
