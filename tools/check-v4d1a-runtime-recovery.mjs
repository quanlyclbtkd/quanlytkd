...
check('cache bust updated to V4D1A in index', (index.includes('login-history-large-list-guard-20260703-v5h') || index.includes('profile-canonical-store-runtime-recovery-20260628-v4d1a')));
check('main imports render.js with V4D1A cache bust', (main.includes('./ui/render.js?v=login-history-large-list-guard-20260703-v5h') || main.includes('./ui/render.js?v=profile-canonical-store-runtime-recovery-20260628-v4d1a')));
