...
check('cache bust updated to V4D1A in index', (index.includes('superadmin-access-admin-provisioning-recovery-20260704-v5k') || index.includes('profile-canonical-store-runtime-recovery-20260628-v4d1a')));
check('main imports render.js with V4D1A cache bust', (main.includes('./ui/render.js?v=superadmin-access-admin-provisioning-recovery-20260704-v5k') || main.includes('./ui/render.js?v=profile-canonical-store-runtime-recovery-20260628-v4d1a')));
