...
check(index.includes('app.js?v=attendance-canonical-ownership-20260616') || index.includes('app.js?v=inventory-pagination-complete-debt-20260616'), 'app.js cache bust is current and preserves 4K-6U report isolation');
check(index.includes('main.js?v=attendance-canonical-ownership-20260616') || index.includes('main.js?v=inventory-pagination-complete-debt-20260616'), 'main.js cache bust is current and preserves 4K-6U report isolation');
