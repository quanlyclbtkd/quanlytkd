...
check(index.includes('app.js?v=attendance-canonical-ownership-20260616'), 'app.js cache bust is current and preserves 4K-6U report isolation');
check(index.includes('main.js?v=attendance-canonical-ownership-20260616'), 'main.js cache bust is current and preserves 4K-6U report isolation');
...
check(main.includes("window.APP_BUILD_VERSION = '4K-6V-attendance-canonical-ownership-pagination-20260616'"), 'active build version advances beyond 4K-6U');
