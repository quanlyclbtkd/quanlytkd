...
const v5u1Patch='4K-6V5U-1-student-status-command-cutover-tx-delete-fix-20260722';
...
check('V5S/V5T cache-bust lineage active', (index.includes(`app.js?v=${v5u1Build}`) || index.includes(`app.js?v=${currentBuild}`) || index.includes(`app.js?v=${build}`)) && (index.includes(`js/main.js?v=${v5u1Build}`) || index.includes(`js/main.js?v=${currentBuild}`) || index.includes(`js/main.js?v=${build}`)) && main.includes(`profiles.listeners.js?v=${build}`));
check('V5S behavior retained under V5T patch marker', (app.includes(v5u1Patch) || app.includes(currentPatch) || app.includes(patch)) && (main.includes(v5u1Patch) || main.includes(currentPatch) || main.includes(patch)) && boundary.includes(patch));
