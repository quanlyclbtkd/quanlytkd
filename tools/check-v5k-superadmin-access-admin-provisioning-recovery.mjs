...
check('Public mirrors are synced', (files.publicApp.includes('4K-6V5O-role-runtime-audit-profiler') || files.publicApp.includes('4K-6V5N-debt-zalo-feature-off') || files.publicApp.includes('4K-6V5M-attendance-status-quit-sync') || files.publicApp.includes('4K-6V5K-superadmin-access-admin-provisioning-recovery') || files.publicApp.includes('4K-6V5L-superadmin-revenue-cache-fallback')) && files.publicSuperadmin.includes('forceReplaceAdmin-preflight'));
