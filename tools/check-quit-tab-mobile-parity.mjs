...
const appBuilds = [r1Build, appBuild, previousAppBuild, build, 'profile-canonical-store-runtime-recovery-20260628-v4d1a', 'profile-canonical-store-20260628-v4d1', 'tuition-debt-source-of-truth-20260628-v4c'];
...
check('Index cache-busts app.js and main.js with current quit-safe build',
  ...
  (index.includes(`./js/main.js?v=${r1Build}`) || index.includes(`./js/main.js?v=${dashboardBuild}`) || index.includes(`./js/main.js?v=${searchBuild}`) || index.includes(`./js/main.js?v=${appBuild}`) || index.includes(`./js/main.js?v=${build}`)));
check('Main cache-busts all quit render/profile modules with current quit-safe build',
  (main.includes(`./ui/render.js?v=${dashboardBuild}`) || main.includes(`./ui/render.js?v=${searchBuild}`) || main.includes(`./ui/render.js?v=${build}`)) &&
  (main.includes(`./ui/render/renderStudents.js?v=${r1Build}`) || main.includes(`./ui/render/renderStudents.js?v=${searchBuild}`) || main.includes(`./ui/render/renderStudents.js?v=${build}`)) &&
  (main.includes(`./ui/render/renderInvalidation.js?v=${searchBuild}`) || main.includes(`./ui/render/renderInvalidation.js?v=${build}`)) &&
  (main.includes(`./listeners/profiles.listeners.js?v=${dashboardBuild}`) || main.includes(`./listeners/profiles.listeners.js?v=${build}`)) &&
  (main.includes(`./modules/students.js?v=${r1Build}`) || main.includes(`./modules/students.js?v=${appBuild}`) || main.includes(`./modules/students.js?v=${previousAppBuild}`) || main.includes(`./modules/students.js?v=${build}`)));
check('Nested render imports use current build so mobile cannot reuse stale computation cache',
  (renderJs.includes(`studentsRenderer.js?v=${r1Build}`) || renderJs.includes(`studentsRenderer.js?v=${searchBuild}`) || renderJs.includes(`studentsRenderer.js?v=${build}`)) &&
  (renderStudents.includes(`studentsRenderer.js?v=${r1Build}`) || renderStudents.includes(`studentsRenderer.js?v=${searchBuild}`) || renderStudents.includes(`studentsRenderer.js?v=${build}`)) &&
  (renderInvalidation.includes(`studentsRenderer.js?v=${r1Build}`) || renderInvalidation.includes(`studentsRenderer.js?v=${searchBuild}`) || renderInvalidation.includes(`studentsRenderer.js?v=${build}`)) &&
  ...
  (listRefresh.includes(`studentsRenderer.js?v=${r1Build}`) || listRefresh.includes(`studentsRenderer.js?v=${searchBuild}`) || listRefresh.includes(`studentsRenderer.js?v=${build}`)));
