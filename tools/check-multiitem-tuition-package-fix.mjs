...
if(!(main.includes("4K-6K-D-multiitem-tuition-package-fix-20260608") || main.includes("4K-6K-E-unified-student-search-index-20260608") || main.includes("4K-6K-F-receipt-qr-helper-extraction-20260608"))) fails.push('main version missing');
if(!(html.includes('main.js?v=multiitem-tuition-package-fix-20260608') || html.includes('main.js?v=unified-student-search-index-20260608') || html.includes('main.js?v=receipt-qr-helper-extraction-20260608'))) fails.push('html cache bust missing');
