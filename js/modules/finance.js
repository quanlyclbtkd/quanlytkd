...
import { FinanceService } from '../services/finance.service.js?v=coach-quit-attendance-full-recovery-20260630-v4d5';
import { StudentService } from '../services/students.service.js?v=coach-quit-attendance-full-recovery-20260630-v4d5';
...
export function initTransactionPagination() {
    ...
    import('../utils/pagination.js').then(({
        ...
        import('../services/finance.service.js?v=coach-quit-attendance-full-recovery-20260630-v4d5').then(({ FinanceService }) => {
