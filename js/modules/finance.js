...
import { FinanceService } from '../services/finance.service.js?v=given-name-priority-search-unification-20260703-v5g';
...
export function initTransactionPagination() {
    ...
    import('../utils/pagination.js').then(({
        ...
        import('../services/finance.service.js?v=given-name-priority-search-unification-20260703-v5g').then(({ FinanceService }) => {
