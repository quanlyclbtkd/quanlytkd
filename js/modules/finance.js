...
import { FinanceService } from '../services/finance.service.js?v=canonical-profile-status-branch-boundary-20260701-v5';
...
export function initTransactionPagination() {
    ...
    import('../utils/pagination.js').then(({
        ...
        import('../services/finance.service.js?v=canonical-profile-status-branch-boundary-20260701-v5').then(({ FinanceService }) => {
