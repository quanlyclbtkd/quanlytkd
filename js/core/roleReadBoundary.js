...
(function initRoleReadBoundary(global) {
    ...
    if (global.RoleReadBoundary && global.RoleReadBoundary.version === '4K-6V4A') return;

    const VERSION = '4K-6V4A';
    ...
    function readContext() {
        ...
        return {
            ...
            coachBranch: String(state.coachBranch || global.coachBranch || store.coachBranch || '').trim(),
    ...
    function setContext(input) {
        ...
        if (Object.prototype.hasOwnProperty.call(value, 'coachBranch')) state.coachBranch = String(value.coachBranch || '').trim();
