...
// APP_PATCH_VERSION = '4K-6V5C-coach-attendance-tap-stability-20260701'
...
import { initRender }                          from './ui/render.js?v=coach-attendance-tap-stability-20260701-v5c';
...
import { initStudentIslands, registerStudentsLegacyGlobals }     from './ui/render/renderStudents.js?v=coach-attendance-tap-stability-20260701-v5c';
...
import { registerInvalidationLegacyGlobals }                     from './ui/render/renderInvalidation.js?v=coach-attendance-tap-stability-20260701-v5c';
...
} from './listeners/profiles.listeners.js?v=coach-attendance-tap-stability-20260701-v5c';
...
import { initStudents, initStudentPagination }        from './modules/students.js?v=coach-attendance-tap-stability-20260701-v5c';
...
async function ensureFinanceModuleLoaded(reason = 'finance-needed') {
    ...
    if (!__financeModulePromise) {
        __financeModulePromise = import('./modules/finance.js?v=coach-attendance-tap-stability-20260701-v5c')
            .then((mod) => {
                __financeModule = mod;
...
import { initAttendance }                             from './modules/attendance.js?v=coach-attendance-tap-stability-20260701-v5c';
...
window.APP_PATCH_VERSION = '4K-6V5C-coach-attendance-tap-stability-20260701';
