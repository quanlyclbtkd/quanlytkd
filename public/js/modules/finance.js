...
import { FinanceService } from '../services/finance.service.js?v=login-history-large-list-guard-20260703-v5h';
...
export function initTransactionPagination() {
    ...
    import('../utils/pagination.js').then(({
        ...
        import('../services/finance.service.js?v=login-history-large-list-guard-20260703-v5h').then(({ FinanceService }) => {
