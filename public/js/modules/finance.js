...
import { FinanceService } from '../services/finance.service.js?v=coach-reminder-attendance-stability-20260701-v5b';
...
export function initTransactionPagination() {
    ...
    import('../utils/pagination.js').then(({
        ...
        import('../services/finance.service.js?v=coach-reminder-attendance-stability-20260701-v5b').then(({ FinanceService }) => {
