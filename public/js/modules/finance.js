...
import { FinanceService } from '../services/finance.service.js?v=superadmin-access-admin-provisioning-recovery-20260704-v5k';
...
export function initFinance() {
    ...
    window.deleteTx = async (id, relatedInvId) => {
        ...
        // Xóa giao dịch chính. Phase 4K-6V5D: catch permission-denied
...
export function initTransactionPagination() {
    ...
    import('../utils/pagination.js').then(({
        ...
        import('../services/finance.service.js?v=superadmin-access-admin-provisioning-recovery-20260704-v5k').then(({ FinanceService }) => {
