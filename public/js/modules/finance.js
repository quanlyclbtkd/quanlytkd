...
import { FinanceService } from '../services/finance.service.js?v=attendance-status-quit-sync-20260704-v5m';
...
export function initTransactionPagination() {
    ...
    import('../utils/pagination.js').then(({
        ...
        import('../services/finance.service.js?v=attendance-status-quit-sync-20260704-v5m').then(({ FinanceService }) => {
