...
// APP_BUILD_VERSION = '4K-6V4D9-coach-roster-hydration-rules-repair-20260630'
...
import { initRender }                          from './ui/render.js?v=coach-roster-hydration-rules-repair-20260630-v4d9';
...
import { initStudentIslands, registerStudentsLegacyGlobals }     from './ui/render/renderStudents.js?v=coach-roster-hydration-rules-repair-20260630-v4d9';
...
import { registerInvalidationLegacyGlobals }                     from './ui/render/renderInvalidation.js?v=coach-roster-hydration-rules-repair-20260630-v4d9';
...
} from './listeners/profiles.listeners.js?v=coach-roster-hydration-rules-repair-20260630-v4d9';
...
import { initStudents, initStudentPagination }        from './modules/students.js?v=coach-roster-hydration-rules-repair-20260630-v4d9';
...
import { initAttendance }                             from './modules/attendance.js?v=coach-roster-hydration-rules-repair-20260630-v4d9';
...
// Phase 4K-6V4D9: expose profile listener APIs immediately after module imports.
// Root cause from HLV console: app.js initSaaSDatabase can run while main.js is
// still inside its async bootstrap, before the old late exposure at the end of
// bootstrap. Coach accounts then fail-closed with "Coach profiles module
// unavailable" and never hydrate the attendance roster.
    ...
    try {
        ...
        if (!window.__runtimeRecoveryListenerRegistered) {
            ...
            window.addEventListener('app:context-ready', function _onAppContextReady() {
                ...
                setTimeout(function() {
                    if (window.RoleReadBoundary?.isCoachAttendanceOnly?.() === true) return;
...
window.APP_PATCH_VERSION = '4K-6V4D9-coach-roster-hydration-rules-repair-20260630';
