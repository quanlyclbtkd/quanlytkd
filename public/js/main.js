...
// APP_PATCH_VERSION = '4K-6V4D9-coach-attendance-warning-cleanup-20260630'
...
import { initRender }                          from './ui/render.js?v=coach-attendance-warning-cleanup-20260630-v4d9';
...
import { initStudentIslands, registerStudentsLegacyGlobals }     from './ui/render/renderStudents.js?v=coach-attendance-warning-cleanup-20260630-v4d9';
...
import { registerInvalidationLegacyGlobals }                     from './ui/render/renderInvalidation.js?v=coach-attendance-warning-cleanup-20260630-v4d9';
...
} from './listeners/profiles.listeners.js?v=coach-attendance-warning-cleanup-20260630-v4d9';
...
import { initStudents, initStudentPagination }        from './modules/students.js?v=coach-attendance-warning-cleanup-20260630-v4d9';
...
async function ensureFinanceModuleLoaded(reason = 'finance-needed') {
    ...
    if (!__financeModulePromise) {
        __financeModulePromise = import('./modules/finance.js?v=coach-attendance-warning-cleanup-20260630-v4d9')
            .then((mod) => {
                __financeModule = mod;
...
import { initAttendance }                             from './modules/attendance.js?v=coach-attendance-warning-cleanup-20260630-v4d9';
...
window.APP_PATCH_VERSION = '4K-6V4D9-coach-attendance-warning-cleanup-20260630';
