...
async function syncClubStatsCache(reason = 'manual') {
  ...
  _syncInFlight = (async () => {
    ...
    const payload = {
      ...
      // Phase 4K-6V5L: write compatible root revenue aliases for SuperAdmin revenue tab.
      monthlyIncome: stats.monthlyIncome,
      totalRevenue: stats.monthlyIncome,
      totalIncome: stats.monthlyIncome,
      incomeTotal: stats.monthlyIncome,
    ...
    try {
      await setDoc(doc(db, 'clubs', cid, 'stats', statsDocId), {
        ...
        totalIncome: stats.monthlyIncome,
        totalRevenue: stats.monthlyIncome,
        revenue: stats.monthlyIncome,
        revenueTotal: stats.monthlyIncome,
        incomeTotal: stats.monthlyIncome,
        monthlyIncome: stats.monthlyIncome,
        monthlyRevenue: stats.monthlyIncome,
