...
Bản này chủ yếu là source/runtime search. Nếu bạn đã deploy Firestore Rules V5C để sửa xóa giao dịch thì V5D chỉ cần deploy Hosting/source. Sau deploy nên hard refresh hoặc xóa cache site để chắc chắn bundle mới `audit-gate-superadmin-hardening-20260703-v5e` được tải.
